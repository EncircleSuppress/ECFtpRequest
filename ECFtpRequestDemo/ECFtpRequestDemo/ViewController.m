...
@property (nonatomic, strong) ECFtpRequest *ftpRequest;

@end

#warning 这里填写ftp登录的信息

static NSString * const FTP_ADDRESS = @"";
static UInt16     const FTP_Port = 6028;
static NSString * const USERNAME = @"";
static NSString * const PASSWORD = @"";

@implementation ViewController

- (ECFtpRequest *)ftpRequest
{
    if (!_ftpRequest) {
        _ftpRequest = [[ECFtpRequest alloc] initFTPClientWithUserName:USERNAME userPassword:PASSWORD serverIp:FTP_ADDRESS serverHost:FTP_Port];
    }
    return _ftpRequest;
}
